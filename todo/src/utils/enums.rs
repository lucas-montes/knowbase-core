...
impl Priority {
    pub fn to_dialog_alarm(&self) -> String {
        match self {
            Priority::High => String::from("dialog-warning"),
            Priority::Medium => String::from("dialog-information"),
            Priority::Low => String::from("dialog-question"),
        }
    }
}
